  ...
  return (
    <div className='relative h-[500px]'>
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col gap-5 items-center justify-center">
            ...
            <div className="flex items-center justify-center text-xl border-2 border-white hover:bg-white hover:text-black duration-200 size-[3.8rem] ps-1 rounded-full">
                <FaPlay className=''/>
            </div>
        </div>
    </div>
